...
const Profile = () => {
  ...
  function handleFile(event) {
    ...
    // if (name === "Degree_Certificate" && file.type !== "application/pdf") {
    //   // Display an error message or perform other actions
    //   console.error("Only PDF files are allowed for Degree Certificate");
    //   return;
    // }
    if (!file) {
        ...
        <div className="container">
          ...
          <div className="row main">
            ...
            <div className="col-lg-9">
              ...
              <input type="file" name="Offer_Letter" onChange={handleFile} accept="application/pdf"/>
            </div>
          </div>
          <div className="row main">
            <div className="title col-lg-3">
